...
const DashboardComments = () => {
  ...
  const handleShowMore = async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_API_URL}/api/comment/getcomments?startIndex=${startIndex}`
      )
  ...
  const handleDeleteComment = async () => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_API_URL}/api/comment/deleteComment/${commentIdToDelete}`,
        {
          method: "DELETE",
        }
      )
